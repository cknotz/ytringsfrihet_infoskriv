...
<div class="parallax-container"><div class="parallax-image-container_1"></div></div>
...
<div class="parallax-container"><div class="parallax-image-container_2"></div></div>
...
<div class="parallax-container"><div class="parallax-image-container_3"></div></div>
...
Men versjon 2 viste også et bilde av Simen Velle, en kjent ung politiker som er veldig aktiv på sosiale medier, og tilskrev uttalelsene direkte til ham (han kom faktisk med disse uttalelsene i en TV-debatt).
...
<div class="parallax-container"><div class="parallax-image-container_4"></div></div>
...
<div class="parallax-container"><div class="parallax-image-container_5"></div></div>
...
<div class="parallax-container"><div class="parallax-image-container_6"></div></div>
...
<div class="parallax-container"><div class="parallax-image-container_7"></div></div>
...
<div class="parallax-container"><div class="parallax-image-container_8"></div></div>
...
Nei. Selvfølgelig kunne vi ikke fortelle deltakerne om eksperimentet, for da ville det ikke ha fungert. Men først og fremst ga vi ikke deltakerne våre feil informasjon: Simen har faktisk uttalt disse påstandene – og han er ikke den eneste som kommer med slike uttalelser om ytringsfrihet, så det er også korrekt at «folk» sier disse tingene.

Teknisk sett har vi kun vist at folk reagerer forskjellig på en uttalelse om ytringsfrihet avhengig av hvordan uttalelsen er «innrammet» (om den kommer fra en politisk *influenser* eller fra «folk») – og dette er ikke det samme som en grunnleggende endring i deres politiske overbevisninger eller ideologi. Vi vet også fra tidligere forskning at denne typen *«framing»*-effekter ikke er så stabile, spesielt når folk senere blir eksponert for ulike utsagn. Likevel er det viktig å vise at personer som Simen faktisk kan ha denne påvirkningen på i det minste noen av oss.
