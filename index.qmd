...
Vi sendte deretter respondentene tilfeldig til den ene eller den andre versjonen av spørreskjemaet og sammenlignet senere svarene: Svarte de som tilfeldigvis så Simen annerledes enn de som ikke så ham?
...
Vi vet at menn og kvinner --- og spesielt unge menn og kvinner --- ofte har veldig forskjellige politiske meninger, og det kan være at dette også påvirker hvordan de reagerer på en høyreorientert *influenser* som Simen.
